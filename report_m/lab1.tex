...
\begin{figure}[h]
\center{\includegraphics[width=1\linewidth]{img/img_table_1.png}}
\caption{Граф с выделенным критическим путём}
\label{ris:image}
\end{figure}
...
\begin{figure}[h]
\center{\includegraphics[width=1\linewidth]{img/img_table_2.png}}
\caption{Граф с выделенным критическим путём}
\label{ris:image}
\end{figure}
...
\begin{figure}[h]
\center{\includegraphics[width=1\linewidth]{img/img_table_3.png}}
\caption{Граф с выделенным критическим путём}
\label{ris:image}
\end{figure}
